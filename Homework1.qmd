...
-   The **median price** differs acrossn the clarity types.
-   Clarity grades like **IF** and **VVS1** shows a *low median prices*, despite being high quality.
-   Diamonds with *lower clarity* (e.g., **I1**, **SI2**) shows **higher median prices**, because of the large carat size.
